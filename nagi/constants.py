...
THRESHOLD_THETA_DECAY_RATE = 0.001  # (0, 1), lower value means slower decay
...
LIF_REFRACTORY_PERIOD = 2  # in ms
LIF_RESTING_MEMBRANE_POTENTIAL = 0
LIF_MEMBRANE_DECAY_RATE = 0.001
...
FOOD_SAMPLES_PER_SIMULATION = 25
INPUT_SAMPLES_PER_SIMULATION = 4 * 16
MAX_HEALTH_POINTS = FOOD_SAMPLES_PER_SIMULATION * NUM_TIME_STEPS
FLIP_POINT_1D = int(FOOD_SAMPLES_PER_SIMULATION / 5)
FLIP_POINT_2D = 4
...
DAMAGE_PENALTY_FOR_HIDDEN_NEURONS = 1.01
