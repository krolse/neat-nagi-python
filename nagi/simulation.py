...
class OneDimensionalEnvironment(object):
    ...
    def _get_input_frequencies(self, time_step: int, sample: Food, eat_actuator: List[int], avoid_actuator: List[int],
        ...
        return [*self._encode_sample(sample), reward_frequency, penalty_frequency]
...
class TwoDimensionalEnvironment(object):
    ...
    def _get_input_frequencies(self, time_step: int, sample: Food, eat_actuator: List[int], avoid_actuator: List[int],
                               previous_reward_frequencies: List[int]) -> List[int]:
        eat_count = TwoDimensionalEnvironment._count_spikes_within_time_window(time_step, eat_actuator)
        avoid_count = TwoDimensionalEnvironment._count_spikes_within_time_window(time_step, avoid_actuator)
